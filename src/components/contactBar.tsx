    ...
    return(
        <div className={style.bar} style={{
            ...
            <div className={style.mailDiv}>
                <a style={{color:borderTextAndSvgColor}} target='_blank' href="mailto:shobhit.dev.work@gmail.com">shobhit.dev.work@gmail.com</a>
                <a href="mailto:shobhit.dev.work@gmail.com" target='_blank'>
                    {/* gmail icon svg */}
            ...
            <a href="https://github.com/shobhit747" target='_blank'>
                {/* github icon svg */}
                <svg width="34" height="34" viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <a href="https://www.linkedin.com/in/shobhit-thakur/" target='_blank'>
                {/* linkedin icon svg */}
                <svg width="34" height="34" viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg">
